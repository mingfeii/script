...
add wave -noupdate -expand -label sim:/tb_sc_fifo/dut/Group1 -group {Region: sim:/tb_sc_fifo/dut} /tb_sc_fifo/dut/rd_req
...
WaveRestoreCursors {{Cursor 1} {117555 ps} 0}
...
update
WaveRestoreZoom {5828 ps} {395777 ps}
